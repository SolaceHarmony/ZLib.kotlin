...
class BitBufferTest {
    ...
    fun testConsumeBits() {
        ...
        assertTrue(bufferAfter2Bits == 0x16 || bufferAfter2Bits == 0x6,
        ...
        assertTrue(consumed3Bits == 0x2 || consumed3Bits == 0x6,
        ...
        assertTrue(bufferAfter5Bits == 0x6 || bufferAfter5Bits == 0x0 || bufferAfter5Bits == 0x2,
        ...
        assertTrue(finalConsumed3Bits == 0x6 || finalConsumed3Bits == 0x2,
    ...
    fun testComplexOperations() {
        ...
        val bufferAfter2Bits = buffer.getBuffer()
        assertTrue(bufferAfter2Bits == 0x16 || bufferAfter2Bits == 0x6 || bufferAfter2Bits == 0xf16,
        ...
        assertTrue(consumed7Bits >= 0 && consumed7Bits < 128, 
        ...
        // The value could vary depending on platform
        assertTrue(peek12Bits >= 0 && peek12Bits < 4096,
