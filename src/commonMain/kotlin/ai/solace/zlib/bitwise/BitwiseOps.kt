...
class BitwiseOps {
    companion object {
         ...
         */
        fun combine16Bit(high: Int, low: Int, engine: BitShiftEngine): Long {
         ...
         */
        fun getHigh16Bits(value: Long, engine: BitShiftEngine): Long {
         ...
         */
        fun leftShift(value: Long, bits: Int, engine: BitShiftEngine): ShiftResult {
         ...
         */
        fun rightShift(value: Long, bits: Int, engine: BitShiftEngine): ShiftResult {
         ...
         */
        fun unsignedRightShift(value: Long, bits: Int, engine: BitShiftEngine): ShiftResult {
